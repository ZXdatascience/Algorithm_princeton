...
public class BaseballElimination {
	...
	public int wins(String team) {
		...
		if (!nameMap.containsKey(team)) throw new java.lang.IllegalArgumentException();
	...
	public int against(String team1, String team2) {
		...
		if (!nameMap.containsKey(team1) || !nameMap.containsKey(team2)) throw new java.lang.IllegalArgumentException();
	...
	private FlowNetwork constructGraph(String team, ArrayList<Integer> otherTeams) {
		...
		for (int i = 0; i < numOfOtherTeams; i++) {
			for (int j = i + 1; j < numOfOtherTeams; j++) {
				...
				FlowEdge winSideEdge1 = new FlowEdge(count, graph.V() - 1 - numOfOtherTeams + i, Double.MAX_VALUE);
				FlowEdge winSideEdge2 = new FlowEdge(count, graph.V() - 1 - numOfOtherTeams + j, Double.MAX_VALUE);
				graph.addEdge(winSideEdge1);
				graph.addEdge(winSideEdge2);				
				count++;
			}
